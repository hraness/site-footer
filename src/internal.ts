...
const HRANESS_SITE_FOOTER_BRAND_HTML = `<a aria-label="Hraness home" class="${footerClasses.brand}" href="https://hraness.com/">${RA_MARK}<span class="${footerClasses.wordmark}">hraness</span></a>`;
